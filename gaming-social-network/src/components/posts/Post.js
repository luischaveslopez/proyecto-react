...
import { doc, updateDoc, arrayUnion, arrayRemove, getDoc, deleteDoc, addDoc, collection, serverTimestamp } from 'firebase/firestore';
        ...
        <DialogContent sx={{ p: 0 }}>
          <Box sx={{ maxHeight: 400, overflowY: 'auto', p: 2 }}>
            ...
            {(!post.comments || post.comments.length === 0) && (
              ...
              >
                <EmojiIcon sx={{ fontSize: 40, color: 'text.secondary', mb: 1 }} />
                <Typography variant="body2" color="text.secondary">
